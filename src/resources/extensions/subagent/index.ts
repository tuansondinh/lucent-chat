...
// cmux terminal-split integration removed (not applicable in Electron/RPC context)
// eslint-disable-next-line @typescript-eslint/no-explicit-any
type CmuxClient = any;
const shellEscape = (s: string) => s;
...
// runSingleAgentInCmuxSplit removed — cmux terminal splits not applicable in Electron context
async function _unused_runSingleAgentInCmuxSplit(
