...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@lc/tui";
...
const THEME_KEY = Symbol.for("@lc/runtime:theme");
...
export function getSettingsListTheme(): import("@lc/tui").SettingsListTheme {
	return {
