...
'use strict'
/**
 * validate-bundle.cjs — Validates that the @lc/runtime bundle is complete.
 *
 * Checks:
...
console.log('[validate-bundle] Validating @lc/runtime bundle...')
console.log(`  Bundle dir: ${BUNDLE_DIR}`)
console.log()

// 1. Bundle directory exists
check('bundle/ directory exists', existsSync(BUNDLE_DIR), 'Run: npm run bundle -w @lc/runtime')
