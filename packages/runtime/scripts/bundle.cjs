...
'use strict'
/**
 * bundle.cjs — Builds a self-contained @lc/runtime bundle directory.
 *
...
writeJson(join(BUNDLE_DIR, 'package.json'), {
  name: '@lc/runtime-bundle',
  version: rootVersion,
  description: 'Self-contained @lc/runtime bundle for Lucent Chat Studio',
  type: 'module',
  main: './entrypoint.js',
})
