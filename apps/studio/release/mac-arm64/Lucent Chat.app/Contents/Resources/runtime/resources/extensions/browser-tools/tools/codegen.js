...
export function registerCodegenTools(pi, deps) {
    pi.registerTool({
        ...
        parameters: Type.Object({
            name: Type.Optional(Type.String({ description: "Test name (used for describe/test block and filename). Default: 'recorded-session'." })),
            ...
            includeAssertions: Type.Optional(Type.Boolean({ description: "Include assertion steps from the timeline (default: true)." })),
        }),
