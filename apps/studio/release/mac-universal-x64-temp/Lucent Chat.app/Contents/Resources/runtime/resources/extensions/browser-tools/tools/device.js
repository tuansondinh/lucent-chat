    ...
    pi.registerTool({
        ...
        async execute(_toolCallId, params, _signal, _onUpdate, _ctx) {
            try {
                ...
                // Wire up state
                const { setBrowser, setContext, pageRegistry, setSessionStartedAt, setSessionArtifactDir, resetAllState, } = await import("../state.js");
                ...
                if (currentUrl && currentUrl !== "about:blank") {
                    await page.goto(currentUrl, { waitUntil: "domcontentloaded", timeout: 15000 }).catch((e) => { if (process.env.GSD_DEBUG)
