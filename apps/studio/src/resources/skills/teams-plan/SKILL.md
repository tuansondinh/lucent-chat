...
If **yes**:
1. Read `.ralph-teams/PLAN-[N].md`.
2. Run via Bash:
   ```bash
   echo "Review this implementation plan. Identify missing phases, edge cases, or architectural gaps. Be concise.\n\n$(cat .ralph-teams/PLAN-[N].md)" | codex exec -m gpt-5.4
   ```
3. Evaluate the feedback. Incorporate valid findings into `.ralph-teams/PLAN-[N].md`.
